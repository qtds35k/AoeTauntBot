...
async def help(ctx):
    ...
    embed.add_field(name='May 2025', value=additionalTaunt, inline=False)
    
    additionalTaunt = 'air, barracks, boring, boring2, boring3, fire, nowood'
    embed.add_field(name='Aug 2025', value=additionalTaunt, inline=False)
    
    additionalTaunt = 'zz, zzz'
    embed.add_field(name='Sep 2025', value=additionalTaunt, inline=False)
    
    additionalTaunt = 'jan, respect, sit'
    embed.add_field(name='Sep 2025', value=additionalTaunt, inline=False)
