...
@client.command(aliases=['1', '2', '2ja', '3', '4', '5', '6', '7', '8', '9', '11', '12', '13', '14', '18', '23', '24', '29', '30', '34', '35', '41', '69', '104', '105', '301', '302', 'agu', 'ah', 'ahnia', 'baan', 'bling', 'brush', 'call', 'crap', 'dick', 'dick2', 'dick3', 'die', 'die2', 'dio', 'dog', 'door', 'dunno', 'eh', 'eh2', 'fine', 'fine2', 'fine3', 'g', 'gan', 'gan2', 'gan3', 'gg', 'gibai', 'go', 'go2', 'guan', 'hehe', 'hey', 'hey2', 'imp', 'in', 'in2', 'iyo', 'justice', 'lilai', 'luv', 'ma', 'maja', 'majaja', 'me', 'nene', 'no', 'nodick', 'oyo', 'perv', 'pogo', 'quack', 'roger', 'say', 'spag', 'turk', 'up', 'wait', 'wifi', 'yahoo', 'yay', 'yay2', 'zawarudo'])
async def taunt(ctx):
    botMessage = ''
...
async def help(ctx):
    ...
    additionalTaunt = '2ja, 41, 69, ah, ahnia, baan, call, dick, dick2, dick3, die, die2, dio, dunno, fine2, fine3, g, gan, gan2, gan3, gibai, go, go2, guan, hehe, imp, in, in2, iyo, justice, luv, maja, majaja, me, nene, no, nodick, oyo, quack, roger, say, spag, turk, up, wait, wifi, yahoo, yay, yay2, zawarudo'
