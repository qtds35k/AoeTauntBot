...
async def on_voice_state_update(member, before, after):
    ...
    if after.channel is not None and before.channel != after.channel:
        ...
        if os.path.exists(AUDIO_DIR):
            ...
            # 1. Check if user has a perfectly mapped specific single taunt
            ...
            # 2. Check if user is mapped to a Voice Group
                ...
                if voice_id in TAUNT_VOICE_GROUPS:
                    ...
                    if random.random() < 0.50:
                        ...
                        if valid_taunts:
                            ...
                            print(f"[GROUP HIT] User {user_name} mapped to {voice_id}. Selected {selected_taunt}")
            
            # 3. Handle unmapped users OR 50% chance fallback for mapped users
            if selected_taunt is None:
                if user_name not in USER_VOICE_MAPPING:
