...
@client.command(aliases=['1', '2', '2ja', '3', '4', '5', '6', '7', '8', '9', '11', '12', '13', '14', '18', '23', '24', '29', '30', '34', '35', '69', '104', '105', '301', '302', 'ahnia', 'bling', 'crap', 'die', 'die2', 'dio', 'dog', 'door', 'fine', 'fine2', 'fine3', 'gan', 'gan2', 'gan3', 'gg', 'gibai', 'guan', 'hey', 'hey2', 'in', 'iyo', 'lilai', 'ma', 'maja', 'majaja', 'me', 'nene', 'perv', 'pogo', 'quack', 'roger', 'say', 'spag', 'turk', 'wifi', 'yahoo', 'zawarudo'])
async def taunt(ctx):
    botMessage = ''
...
async def help(ctx):
    ...
    additionalTaunt = '2ja, 69, ahnia, die, die2, dio, fine2, fine3, gan, gan2, gan3, gibai, guan, in, iyo, maja, majaja, me, nene, quack, roger, say, spag, turk, wifi, yahoo, zawarudo'
